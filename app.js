    ...
    // remove datas default from HTML
        ...
        if(products.length > 0) // if has data
        {
            products.forEach(product => {
                ...
                newProduct2.classList.add('item');
                ...
                newProduct3.classList.add('item');
                newProduct3.innerHTML =
                    `
                    <img src="${product.image}">
                    <div class="content">
                        <div class="author">get</div>
                        <div class="title">the</div>
                        <div class="topic">${product.name}</div>
                        <div class="des">
                            for only $${product.price}
                        </div>
                        <div class="buttons">
                            <button><a href="#products">SEE MORE</a></button>
                            <button onclick="addToCartWithInfo('${product.id}', '${product.image}', '${product.name}', '${product.price}')">add to cart</button>

                        </div>
                    </div>
                    `;
                
                thumbnail.appendChild(newProduct2);
                listProductHTML.appendChild(newProduct);
                SliderDom.appendChild(newProduct3);

            });
        }
    }
    // Event-Listener für "Add to Cart"-Schaltfläche hinzufügen
...
function addToCartWithInfo(productID, imageSrc, productName, productPrice) {
  // Überprüfen, ob das Produkt bereits im Warenkorb ist
  let existingCartItemIndex = cart.findIndex(item => 
